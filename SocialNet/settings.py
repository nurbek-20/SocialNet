...
SECRET_KEY = 'django-insecure-(r1pfjalp-p^=#hlds*#8^+x_51=w&9f(&ao8d5(ica_of+%uv'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'socialnet',  # Имя вашей базы данных
        'USER': 'nurbeksocialnet',      # Имя вашего пользователя
